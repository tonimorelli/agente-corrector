...
- La branch local `andreavergara-h2-ev1-ev3` trabajada el 07/09 todavía no está publicada en GitHub.
- Por eso H2 sigue pendiente en el estado remoto.
- H2 no bloquea el resto del trabajo de hoy: afecta principalmente la interpretación EV1/EV3 en S2 y E1 y el cierre metodológico final.
...
| 2 | Segunda corrida de Excelente, Flojo y Tramposo | Mateo + Tomás | Correr nuevamente el agente sobre los mismos casos, sin cambiarlos, y comprobar que mantiene las notas y criterios. |
...
No estamos en etapa de construir cosas nuevas.

**Rúbrica, agente y casos ya existen.**

De acá a la entrega el objetivo es:

- probar que funcionan de forma consistente;
- cerrar los pocos pendientes;
- actualizar la documentación;
- hacer el control final.
...
Lo que no debe cerrarse definitivamente hasta resolver H2 es:

- la validación metodológica final de la rúbrica;
- la calibración completa;
- el congelamiento final de `main`.
